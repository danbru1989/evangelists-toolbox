...
add_action( 'acf/render_field/key=field_5c6b29ef6e70d', 'bdset_output_organizations_quick_actions' );
/**
 ...
 * @return void
 */
function bdset_output_organizations_quick_actions() {

	if ( ! get_field( 'primary_organization_contact' ) ) {

		echo '<div class="bdset-notice">Please save a primary contact to see more details...</div>';
...
// add_action( 'acf/render_field/key=field_5c6b29ef91dc9', 'bdset_output_other_contacts_info', 1 );
/**
 ...
 * @return void
 */
function bdset_output_other_contacts_info() {
