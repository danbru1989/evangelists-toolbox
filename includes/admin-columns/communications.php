...
add_filter( 'manage_communication_posts_columns', 'bdset_change_communication_columns_header' );
 ...
 * @return $columns
 */
function bdset_change_communication_columns_header( $columns ) {
...
add_action( 'manage_communication_posts_custom_column', 'bdset_change_communication_columns_content', 10, 2 );
/**
 ...
 * @return void
 */
function bdset_change_communication_columns_content( $column, $post_id ) {
	...
	// Contact Column.
	if ( 'contact' === $column ) {
		$contact = bdset_get_full_title_contact( $communication_group['communication_contact'] );
...
add_filter( 'manage_edit-communication_sortable_columns', 'bdset_communications_sortable_columns' );
/**
 ...
 * @return $columns
 */
function bdset_communications_sortable_columns( $columns ) {
	$columns['timestamp'] = 'date';
	$columns['contact']   = 'contact';
	return $columns;
}

add_action( 'pre_get_posts', 'bdset_communications_columns_sort_query', 1 );
/**
 ...
 * @return void
 */
function bdset_communications_columns_sort_query( $query ) {
